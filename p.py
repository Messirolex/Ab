...
# Telegram bot token
TOKEN = '7344990517:AAF5lV3qv8N1ys7MTOnZ4xrJ8Y5CCoLakSM'
...
async def server_info(ctx):
    ...
    # Fetch bot uptime dynamically
    bot_uptime = int(time.time() - bot.start_time)
    uptime_str = str(datetime.timedelta(seconds=bot_uptime))
